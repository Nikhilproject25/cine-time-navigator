...
import { Film, Home, Search, User, Calendar, Ticket } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Sports & Events', path: '/sports-events', icon: Calendar },
    { name: 'My Bookings', path: '/my-bookings', icon: Ticket },
    { name: 'Assistant', path: '/assistant', icon: Search },
